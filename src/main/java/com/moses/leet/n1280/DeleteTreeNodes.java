...
//        System.out.println(Arrays.toString(nodeSum));
    ...
    boolean notZero(int i, int[] nodeSum, int[] parent){
        if(nodeSum[i] == 0){
            return false;
        }
        while(parent[i] != -1){
